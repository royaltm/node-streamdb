...
exports.createSchemaDescriptor = function(property, schemaCfg) {
  ...
  if (schema.hasOne) {
    if (property.includes('.')) throw new SchemaSyntaxError("unimplemented schema nested relation");
    ...
    if (foreign) {
      ...
      defineProperty(foreignProto, foreign, foreignPropertyDescriptor(descr, this[$items]));
    ...
    if (property.includes('.')) throw new SchemaSyntaxError("unimplemented schema nested unique index");
    ...
    if (property.includes('.')) throw new SchemaSyntaxError("unimplemented schema nested index");
    ...
    if (property.includes('.')) throw new SchemaSyntaxError("unimplemented schema nested Date");
