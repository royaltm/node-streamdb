...
const { datePropertyDescriptor
      ...
      , compositeIndexPropertyDescriptor
      , proxyPropertyDescriptor } = require('./descriptors');
...
const { COLLECTION_NAME_MATCH
      ...
      , validateDeepPropertyCrossReference
...
exports.validateDeepPropertyCrossReference = validateDeepPropertyCrossReference;
...
const schemaProto = freeze(copyOwnProperties(create(null), {
  ...
  [Symbol.for("indexDescriptorsIterate")]() {
    return this[indexDescriptors$][iterator]();
  },
  [Symbol.for("hasManyDescriptorsIterate")]() {
    return this[hasManyDescriptors$][iterator]();
  },
  [Symbol.for("hasOneDescriptorsIterate")]() {
    return this[hasOneDescriptors$][iterator]();
  },
  /*
...
exports.addSchemaCompositeIndex = function(indexName, schemaCfg) {
  ...
  for(var [idx, property] of indexCfg.components.entries()) {
    ...
    descr = prepareLayeredIndexDescriptor(this, descr, property, indexName + '.');
    ...
    if (indexCfg.unique) {
      ...
      defineProperty(detachedItemProto, descr.name, proxyPropertyDescriptor(descr));
...
exports.addSchemaDescriptor = function(property, schemaCfg, validators) {
  ...
  /* make it exportable */
  if ('function' === typeof schema.type) schema.type = descr.type.name;
  ...
  if (schema.default !== undefined) {
    ...
    /* make it exportable */
    if (descr.default === Date.now) schema.default = 'Date.now';
  }
  ...
  if (schema.hasMany !== undefined || schema.hasOne !== undefined) {
    ...
    if (schema.hasMany !== undefined) {
      ...
      defineProperty(detachedItemProto, property, proxyPropertyDescriptor(descr));
    ...
    if (schema.unique) {
      ...
      let unique = new UniqueIndex()
        , idescr = prepareLayeredIndexDescriptor(this, descr, property, '');
      idescr.indexName = property;
      idescr.unique = unique;
      if (descr !== idescr) descr.unique = unique; /* for reflection and destructor */
      defineProperty(detachedItemProto, idescr.name, proxyPropertyDescriptor(idescr));
...
function prepareLayeredIndexDescriptor(collection, descr, property, prefixName) {
  ...
  if (descr.readPropertySymbol === undefined) {
    ...
    schema[extend$](collection, descr);
  }
