...
const { isFunction, isPlainObject, isObject, isString } = require('./util');
...
exports.parseModels = function(options, schemaCfg) {
  ...
  if (options.models != null) {
    ...
    for(let name of Object.getOwnPropertyNames(options.models)) {
      ...
      if (!isFunction(model)) {
        ...
        function Mixin() {}
        Mixin.prototype = copyProperties(create(Item.prototype), model);
...
exports.parseValidators = function(options, models, schemaCfg) {
  ...
  if (options.validators != null) {
    ...
    for(let name of Object.getOwnPropertyNames(options.validators)) {
  ...
  for(let name of Object.getOwnPropertyNames(models)) {
...
function addValidator(name, validator, schemaCfg) {
  ...
  for(let prop of Object.getOwnPropertyNames(validator)) {
