...
const genIdent = require('./id').genIdent;
const DBStream = require('./stream');
const { updaters, Collection } = require('./collection');
...
class DB {
  constructor(options) {
    ...
    defineProperty(this, 'collections', {value: new Proxy(this, dbProxyHandler)});
    for(let name in schemaCfg) collections[name] = new Collection(this, name);
