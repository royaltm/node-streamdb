...
class DB extends EventEmitter {
  ...
  **/
  constructor(options) {
    ...
    defineProperty(this, 'types', {value: parseTypes(options)});
    defineProperty(this, 'models', {value: parseModels(options, schemaCfg)});
    defineProperty(this, 'validators', {value: parseValidators(options, this.models, schemaCfg)});
