...
test("CompositeUniqueIndex", suite => {
  ...
  suite.test('should be a composite unique index', t => {
    ...
    t.strictEqual(index.set([1, 2, 3], 'a'), index);
    t.strictEqual(index.size, 1);
    ...
    t.strictEqual(index.get([1, 2, 3]), 'a');
    t.strictEqual(index.set([1, 2, 3], 'b'), index);
    t.strictEqual(index.set([1, 4, 5], 'c'), index);
    t.strictEqual(index.set([1, 2, 4], 'd'), index);
  ...
  suite.test('should treat undefined in a special way', t => {
    ...
    t.strictEqual(index.set([undefined], 'x'), index);
    t.strictEqual(index.size, 0);
    ...
    t.strictEqual(index.size, 0);
    t.strictEqual(index.count(), 0);
    t.strictEqual(index.set([undefined, 1], 'x'), index);
    t.strictEqual(index.has(undefined), false);
    ...
    t.strictEqual(index.set([1, undefined], 'x'), index);
    t.strictEqual(index.size, 1);
    // t.strictEqual(index.length, 1);
    t.type(index.get(1), CompositeUniqueIndex);
    ...
    t.strictEqual(index.set([1, undefined], 'y'), index);
    t.strictEqual(index.size, 1);
    // t.strictEqual(index.length, 1);
    t.type(index.get(1), CompositeUniqueIndex);
    ...
    t.strictEqual(index.set([1, 1], 'z'), index);
    t.strictEqual(index.size, 1);
    // t.strictEqual(index.length, 1);
    t.strictEqual(index.has(1), true);
    t.strictEqual(index.has([1]), true);
    ...
    var index = new CompositeUniqueIndex(3);
    t.strictEqual(index.size, 0);
    t.strictEqual(index.set([undefined, 1, 2], 'x'), index);
    t.strictEqual(index.has(undefined), false);
    t.strictEqual(index.has(undefined, 1), false);
    ...
    t.strictEqual(index.set([1, undefined, 1], 'a'), index);
    t.strictEqual(index.set([1, undefined, undefined], 'b'), index);
    t.strictEqual(index.set([1, 1, 1], 'x'), index);
    t.strictEqual(index.set([1, 1, undefined], 'c'), index);
    t.strictEqual(index.set([1, 2, undefined], 'd'), index);
    t.strictEqual(index.size, 1);
    // t.strictEqual(index.length, 1);
    t.strictEqual(index.has(1), true);
    t.strictEqual(index.has([1]), true);
